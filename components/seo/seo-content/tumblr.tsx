        ...
        <div className="space-y-8 md:space-y-10 py-12 md:py-16">
            ...
            >
                <Badge className="mb-4 bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-blue-500/10 dark:text-blue-300 dark:hover:bg-blue-500/20 px-4 py-1 text-xs font-semibold">
                    About Tumblr Video Downloader
                </Badge>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-gray-900 dark:text-white">Tumblr Video Downloader</h1>
            ...
            >
                ...
                <ol className="space-y-3 mb-6 list-decimal pl-6">
                    <li>Find the Tumblr video you want to save and copy its URL from your browser's address bar.</li>
                    <li>Navigate to the FSMVID website (no registration required!).</li>
                    <li>Paste the URL into the download field.</li>
                    <li>Click the download button to analyze the video.</li>
                    <li>Select your preferred video quality option.</li>
                    <li>Download the video directly to your device.</li>
                </ol>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    <InterlinkText currentPlatform={platform}>
            ...
            >
                ...
                <ol className="space-y-3 mb-6 list-decimal pl-6">
                    <li>Open the Tumblr post containing the video you want to download.</li>
                    <li>Right-click on the video and select "Inspect" or "Inspect Element".</li>
                    <li>In the developer tools panel, search for video source URLs.</li>
                    <li>Copy the direct video URL you find (usually ends with .mp4).</li>
                    <li>Paste this URL in a new browser tab.</li>
                    <li>Right-click on the playing video and select "Save video as".</li>
                </ol>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    <InterlinkText currentPlatform={platform}>
